            ...
            Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              color: Colors.white.withOpacity(0.1), borderRadius: BorderRadius.circular(2)),
                    ...
                    Container(height: 10),
                    Text(object.title,
                        style: MyText.medium(context).copyWith(color: Colors.white, fontWeight: FontWeight.w500)),
                    Container(height: 10),
                  ],
                )),
          ],

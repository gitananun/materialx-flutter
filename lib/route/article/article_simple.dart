                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                        ...
                        style: MyText.subhead(context).copyWith(color: MyColors.grey_90, fontWeight: FontWeight.w500)),
                    Divider(height: 30),
                    Text(MyStrings.lorem_ipsum,
                        textAlign: TextAlign.justify, style: MyText.subhead(context).copyWith(color: MyColors.grey_80)),
                    Container(height: 20),
                    Container(
                      child: Image.asset(
                    ...
                    Text("Image source : pexels.com",
                        textAlign: TextAlign.center, style: MyText.caption(context).copyWith(color: MyColors.grey_40)),
                    Container(height: 20),

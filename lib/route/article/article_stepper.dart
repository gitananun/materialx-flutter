          ...
          Align(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text("Elizabeth".toUpperCase(), style: MyText.subhead(context).copyWith(color: MyColors.grey_10)),
                  Text("Interdum Lectus Bibendum Suspendisse Potenti Nec.",
                      style: MyText.display1(context).copyWith(color: MyColors.grey_3, fontFamily: "serif")),
                  Container(width: 100, height: 2, color: MyColors.grey_10, margin: EdgeInsets.symmetric(vertical: 10)),
                  Text("DIGITAL ECONOMY",
                      style: MyText.subhead(context).copyWith(color: MyColors.grey_20, fontWeight: FontWeight.bold)),
                ],
              ),
            ),
          )
      ...
      child: Stack(
        children: <Widget>[
          Text(text,
              ...
              style: MyText.medium(context).copyWith(color: MyColors.grey_80, fontFamily: "serif", height: 1.6))
        ],
      ),
    );
  }

              ...
              title: Row(
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Text("Miller Wilson", style: MyText.body2(context).copyWith(color: MyColors.grey_80)),
                      Container(height: 2),
                      Row(
                        children: <Widget>[
                          Text("Jul 13", style: MyText.caption(context).copyWith(color: MyColors.grey_60)),
                          Container(
                              width: 6,
                              height: 6,
                              margin: EdgeInsets.symmetric(horizontal: 5),
                              decoration:
                                  BoxDecoration(color: MyColors.grey_40, borderRadius: BorderRadius.circular(15.0))),
                          Text("5 min read", style: MyText.caption(context).copyWith(color: MyColors.grey_60)),
                        ],
                      ),
                    ],
                  )
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Text(MyStrings.short_lorem_ipsum,
                          style:
                              MyText.display1(context).copyWith(color: MyColors.grey_90, fontWeight: FontWeight.bold)),
                    ),
                    Container(height: 5),
                    Container(
                      margin: EdgeInsets.symmetric(horizontal: 15),
                      child: Text("Aliquam ac elit, vestibulum turpis.",
                          style: MyText.title(context).copyWith(color: MyColors.grey_40)),
                    ),
                    Container(height: 20),
                    Container(
                      child: Image.asset(

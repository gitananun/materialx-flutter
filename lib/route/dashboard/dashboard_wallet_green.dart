    ...
    return new Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(backgroundColor: Colors.white, icon: Icon(Icons.equalizer), title: Text('')),
          BottomNavigationBarItem(backgroundColor: Colors.white, icon: Icon(Icons.credit_card), title: Text('')),
          BottomNavigationBarItem(backgroundColor: Colors.white, icon: Icon(Icons.pie_chart_outlined), title: Text('')),
          BottomNavigationBarItem(backgroundColor: Colors.white, icon: Icon(Icons.person), title: Text('')),
        ],
      ),
    );
  }

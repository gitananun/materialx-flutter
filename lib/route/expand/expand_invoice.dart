...
class ExpandInvoiceRouteState extends State<ExpandInvoiceRoute> with TickerProviderStateMixin {
                  ...
                  children: <Widget>[
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        Container(height: 5),
                        Text("Invoice Date",
                            style: MyText.title(context).copyWith(color: Colors.grey, fontWeight: FontWeight.w400)),
                        Container(height: 20),
                        Text("2.30 PM, 22 March 2016",
                            style:
                                MyText.subhead(context).copyWith(color: Colors.grey[800], fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ],
                ),
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Spacer(),
                          Text("\$ 2.026.24", style: TextStyle(fontWeight: FontWeight.bold)),
                          Container(width: 20),
                        ],
                      ),
                      Container(height: 15),

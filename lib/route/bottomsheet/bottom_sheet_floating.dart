          ...
          child: showSheet
              ...
              : Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(height: 20),
                    Text("Press button \nabove",
                        textAlign: TextAlign.center, style: MyText.display1(context).copyWith(color: Colors.grey[600])),
                  ],
                ),
        );
      }),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(MyStrings.middle_lorem_ipsum,
                        style: MyText.subhead(context).copyWith(color: Colors.grey[800])),
                    Container(height: 10),
                    Row(
                      children: <Widget>[
                        Spacer(),
                        StarRating(starCount: 5, rating: 5, color: Colors.orange[300], size: 40),
                        Spacer()
                      ],
                    ),
                    Container(height: 10),

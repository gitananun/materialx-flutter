          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(MyStrings.medium_lorem_ipsum,
                  textAlign: TextAlign.center, style: MyText.subhead(context).copyWith(color: MyColors.grey_90)),
            ),
            Container(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              children: <Widget>[
                                Image.asset(Img.get('image_5.jpg'), width: 35, height: 35, fit: BoxFit.cover),
                                Container(width: 10),
                                Image.asset(Img.get('image_6.jpg'), width: 35, height: 35, fit: BoxFit.cover),
                                Container(width: 10),
                                Image.asset(Img.get('image_7.jpg'), width: 35, height: 35, fit: BoxFit.cover),
                                Container(width: 10),
                                Image.asset(Img.get('image_8.jpg'), width: 35, height: 35, fit: BoxFit.cover),
                                Container(width: 10),
                              ],
                            )
                          ],

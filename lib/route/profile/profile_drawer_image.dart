          ...
          child: Column(
            children: <Widget>[
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                Icon(Icons.location_on, color: MyColors.grey_10, size: 12),
                                Container(width: 5),
                                Text("San Francisco, CA",
                                    style: MyText.body1(context).copyWith(color: MyColors.grey_10)),
                              ],
                            ),
                            Container(height: 40),
                            Row(
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      ...
                                      Container(height: 5),
                                      Text("Followers",
                                          style: MyText.caption(context).copyWith(color: MyColors.grey_10))
                                    ],
                                  ),
                                ),
                                Expanded(
              ...
              Container(
                ...
                child: ListTile(
                  title: Text("Activity",
                      style: MyText.subhead(context).copyWith(color: MyColors.grey_60, fontWeight: FontWeight.bold)),
                  onTap: () {

            ...
            child: Column(
              children: <Widget>[
                    ...
                    Expanded(
                      ...
                      child: Column(
                        children: <Widget>[
                          Text("8825",
                              style:
                                  MyText.title(context).copyWith(color: Colors.grey[900], fontWeight: FontWeight.bold)),
                          Container(height: 5),
                ...
                Text(MyStrings.long_lorem_ipsum,
                    textAlign: TextAlign.justify, style: MyText.subhead(context).copyWith(color: Colors.grey[900])),
                Container(height: 35),
              ],
            ),
          ),

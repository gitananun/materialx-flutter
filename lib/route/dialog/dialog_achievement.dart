  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text("Dialog Achievement", style: MyText.title(context).copyWith(color: MyColors.grey_60)),
          leading: IconButton(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            GestureDetector(
                onTap: () {
                  showDialog(context: context, builder: (_) => CustomChampionDialog());
                },
                child: Padding(
                  padding: const EdgeInsets.fromLTRB(25, 5, 25, 5),
                  child: Container(
            ...
            GestureDetector(
                onTap: () {
                  showDialog(context: context, builder: (_) => CustomLevelDialog());
                },
                child: Padding(
                  padding: const EdgeInsets.fromLTRB(25, 5, 25, 5),
                  child: Container(
            ...
            GestureDetector(
                onTap: () {
                  showDialog(context: context, builder: (_) => CustomRunningDialog());
                },
                child: Padding(
                  padding: const EdgeInsets.fromLTRB(25, 5, 25, 5),
                  child: Container(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            new Text("Run 10km", style: MyText.subhead(context).copyWith(color: Colors.purple[900])),
                            new Icon(
                              Icons.check,
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            new Text("Drink 1.5L of water10km",
                                style: MyText.subhead(context).copyWith(color: Colors.purple[900])),
                            new Icon(
                              Icons.check,
                              color: Colors.purple[900],
                            ),

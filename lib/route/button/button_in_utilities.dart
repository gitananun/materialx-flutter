                      ...
                      child: Container(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text("11,64 MB",
                                style: TextStyle(fontSize: 35, fontWeight: FontWeight.w400, color: Colors.grey[900])),
                            Container(
                              height: 8,
                            ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text("9.40 MB", style: TextStyle(fontSize: 16, color: Colors.grey[400])),
                                    ],
                                  ),
                                  flex: 70,
                                ),
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text("2.18 MB", style: TextStyle(fontSize: 16, color: Colors.grey[400])),
                                    ],
                                  ),
                                  flex: 30,
                                ),

...
class BottomNavigationArticleRouteState extends State<BottomNavigationArticleRoute>
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text("Fusce Aliquam Blandit? Urna Quis Pulvinar. Donec Luctus Tincidunt eu Condimentum",
                          style:
                              MyText.headline(context).copyWith(color: MyColors.grey_90, fontWeight: FontWeight.bold)),
                      Container(height: 10),
                      Text(
                          "Quisque sapien lorem, vestibulum vitae justo eget, fringilla eleifend nisi. Nam fermentum ipsum vitae ligula",
                          style:
                              MyText.subhead(context).copyWith(color: MyColors.grey_90, fontWeight: FontWeight.w500)),
                      Divider(height: 30),
